...
const SpecialsCard = () => {
    const specialMenus = [
        ...
        },
        {
            ...
            title: "Lemon Dessert",
            price: "$5.00",
            description: "This comes straight from Grandma's recipe book. Every last ingredient has been sourced and is as authentic as can be imagined. A unique           dessert.",
            order: "Order a delivery"
        }
    ]
